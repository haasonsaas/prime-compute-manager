...
class JobQueue:
    ...
    def add_job(
        ...
        **kwargs,
        ...
        job.metadata = {"gpu_type": gpu_type, "gpu_count": gpu_count, **kwargs}
    ...
    async def process_all(self) -> None:
        ...
        while self._job_queue or self._running_jobs:
            ...
            while (
                len(self._running_jobs) < self.max_concurrent_jobs and self._job_queue
            ):
            ...
            if self._running_jobs:
                    ...
                    self._running_jobs.values(), return_when=asyncio.FIRST_COMPLETED
                )
