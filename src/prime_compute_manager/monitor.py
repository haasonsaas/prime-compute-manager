...
class ResourceMonitor:
    ...
    def add_alert(
        self, name: str, condition: str, action: str, recipient: str, **kwargs
    ) -> Alert:
        ...
        for alert in self._alerts.values():
            ...
            try:
                ...
                condition = alert.condition.replace(
                    "cost_per_hour", str(usage.current_cost_per_hour)
                )
                ...
                if eval(
                    condition
                ):  # Note: eval is unsafe, use proper parser in production
